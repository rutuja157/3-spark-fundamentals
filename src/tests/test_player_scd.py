...
# ##below is how do we generate data for test-
...
# ## create dataframe with spark using the source data
#     ## now we can use the function we defined in the job to do the transformation
#     ## and then we can compare the output with the expected output
#  ## then we createe the expected output data like below create dataframe with the expected output
