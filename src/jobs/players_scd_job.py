...
# ##to make spark job more testible you can define a function outside of the job like below that just a transformation logic
# ## so then you can use this in yoir test code and test it independently of the spark job coz you dont need
# ## to test the spark session is created or data was written out ,we want to test if does the logic works as expected
# ##